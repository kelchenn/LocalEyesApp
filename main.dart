                ...
                onPressed: () {
                  ...
                  if (wordList.contains(word)) {
                    ...
                    if (!enteredWords.contains(word)) {
                      //calculate how many words they've gotten so far
                      setState(() {
                        foundWords++;
                      });
                    }
                  ...
                  child: FlatButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => Anagrams(eyes, level)),
                      );
                    },
                    child: Text('Play',
                        style: TextStyle(
